...
RSpec.describe GenesisRuby::Api::Mixins::Requests::Financial::Threeds::Version2::Browser do
  ...
  describe 'when threeds_v2_browser_java_enabled' do
    ...
    it 'with empty flag' do
      ...
      expect(browser.threeds_v2_browser_java_enabled).to eq(nil)
    end

    it 'with invalid flag' do
      expect do
        browser.threeds_v2_browser_java_enabled = 'invalid'
      end.to raise_error GenesisRuby::InvalidArgumentError
    end
  end
  ...
  describe 'when threeds_v2_color_depth' do
    ...
    it 'with empty depth' do
      ...
      expect(browser.threeds_v2_browser_color_depth).to eq(nil)
    end

    it 'with invalid depth' do
      expect do
        browser.threeds_v2_browser_color_depth = 0
      end.to raise_error GenesisRuby::InvalidArgumentError
    end
  end
