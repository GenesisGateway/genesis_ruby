...
RSpec.describe GenesisRuby::Api::Constants::Transactions::Parameters::Threeds::Version2::Control::DeviceTypes do

  include_examples 'common constants examples', 'browser'
