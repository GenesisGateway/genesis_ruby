...
RSpec.describe GenesisRuby::Api::Constants::Transactions::Parameters::Threeds::Version2::Purchase::Categories do

  include_examples 'common constants examples', 'goods'
