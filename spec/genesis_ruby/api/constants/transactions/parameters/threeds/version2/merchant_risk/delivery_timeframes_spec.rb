...
RSpec.describe GenesisRuby::Api::Constants::Transactions::Parameters::Threeds::Version2::MerchantRisk::DeliveryTimeframes do

  include_examples 'common constants examples', 'electronic'
