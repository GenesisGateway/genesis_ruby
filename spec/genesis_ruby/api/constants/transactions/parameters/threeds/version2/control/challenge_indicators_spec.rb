...
RSpec.describe GenesisRuby::Api::Constants::Transactions::Parameters::Threeds::Version2::Control::ChallengeIndicators do

  include_examples 'common constants examples', 'no_preference'
