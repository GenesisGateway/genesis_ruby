RSpec.describe GenesisRuby::Api::Requests::Financial::Cards::Authorize3d do
  ...
  include_examples 'preauthorization attributes examples'
  ...
  include_examples 'tokenization params attributes examples'
