RSpec.describe GenesisRuby::Api::Requests::Financial::OnlineBankingPayments::MyBank do
  ...
  let(:request) do
    ...
    request.billing_country    = %w(IT BE PT ES).sample
