RSpec.describe GenesisRuby::Api::Requests::NonFinancial::Fraud::Reports::Transaction do
  let(:config) do
  ...
  describe 'when initialized' do
    it 'with valid endpoint' do
      expect(request.api_config[:url]).to eq 'https://staging.gate.emerchantpay.net:443/fraud_reports'
    end
