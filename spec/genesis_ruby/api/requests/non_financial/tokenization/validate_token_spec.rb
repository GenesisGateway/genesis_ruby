RSpec.describe GenesisRuby::Api::Requests::NonFinancial::Tokenization::ValidateToken do
  ...
  describe 'when initialized' do
    it 'with valid endpoint' do
      expect(request.api_config[:url]).to eq 'https://staging.gate.emerchantpay.net:443/v1/validate_token'
    end

    it 'with XML root element' do
      expect(request.build_document).to include '<validate_token_request>'
    end
  end
