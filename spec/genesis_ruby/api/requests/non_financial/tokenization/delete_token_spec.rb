...
RSpec.describe GenesisRuby::Api::Requests::NonFinancial::Tokenization::DeleteToken do
  ...
  describe 'when initialized' do
    it 'with valid endpoint' do
      expect(request.api_config[:url]).to eq 'https://staging.gate.emerchantpay.net:443/v1/delete_token'
    end

    it 'with XML root element' do
      expect(request.build_document).to include '<delete_token_request>'
    end
  end
